...
| 音视频采集  | sounddevice + numpy (音频), opencv-python-headless (视频) |
...
│   │   ├── voice.py           # 音频设备 API (驱动信息/设备枚举/电平流/录音)
│   │   ├── camera.py          # 摄像头 API (V4L2枚举/快照/MJPEG流)
│   │   └── ws.py              # WebSocket 端点
│   │
│   └── services/              # 业务逻辑层
...
└── frontend/                  # Vue 3 前端
    ...
    └── src/
        ...
        │   ├── VoiceTest.vue      # 输入设备调试页 (/device-debug)
